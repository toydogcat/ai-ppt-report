// Calculus Chapter 6 Decks Metadata
if (typeof PRELOADED_DECKS !== "undefined") {
  PRELOADED_DECKS.push(
    ...
    {
      "id": "calculus-6-9-exercise-set-2",
      "title": "微積分 (Exercise Set 2)",
      "description": "複習微分應用與積分基礎。本詳解涵蓋均值定理、最佳化問題、黎曼和、微積分基本定理與羅必達法則的經典練習題，幫助鞏固核心數學概念。",
      "category": "calculus-ch6",
      "author": "Toby",
      "date": "2026-05-31",
      "tags": [
